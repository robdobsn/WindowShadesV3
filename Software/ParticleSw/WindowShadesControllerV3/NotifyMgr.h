#ifndef _NOTIFY_MGR_H_
#define _NOTIFY_MGR_H_
  ...
  public:
    ...
    int addNotifyPath(String& ipAddr)
    {
      ...
      if (pathToUse != -1)
      {
        ...
        Serial.print("addNotifyPath: ");
        Serial.print(ipAddr);
        Serial.printlnf(" port %d added at %d", _notifyPaths[pathToUse]._port, pathToUse);
        return pathToUse;
      }
      Serial.print("addNotifyPath: ");
      Serial.print(ipAddr);
    ...
    void service()
    {
      ...
      if ((_notifyPaths[_curServicePathIdx]._ipAddrStr.length() != 0) && (_notifyPaths[_curServicePathIdx]._updateOutstanding))
      {
        ...
        {
            Serial.println("Sent notification ok");
        }
