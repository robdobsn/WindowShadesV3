...
public:
    ...
    bool setup()
    {
        ...
        Log.trace(F("ConfigNVS: Config %s read len: %d"CR), _configNamespace.c_str(), configData.length());
        Log.trace(F("ConfigNVS: Config %s read: %s"CR), _configNamespace.c_str(), configData.c_str());
    ...
    bool writeConfig()
    {
        ...
        Log.trace(F("ConfigNVS: Writing %s config len: %d"CR), _configNamespace.c_str(), dataStrLen);
        ...
        {
            Log.trace(F("ConfigNVS: Failed %s write - written = %d"CR), _configNamespace.c_str(), numPut);        
        }
